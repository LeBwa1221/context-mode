...
// resolveContextModeDataRoot / resolveContextModeDataRootOverride live in
// session/data-root.ts (no dependency on session/db.ts) to avoid a cycle:
// this file already imports hashProjectDirCanonical from session/db.js, so
// db.ts importing these back from here would create base.ts -> db.ts ->
// base.ts. Re-exported so existing importers of this module are unaffected.
export { resolveContextModeDataRoot, resolveContextModeDataRootOverride } from "../session/data-root.js";
import { resolveContextModeDataRoot, resolveContextModeDataRootOverride } from "../session/data-root.js";
