...
// Bypasses ContentStore#index (which caps chunks at MAX_CHUNK_BYTES) to
// simulate rows persisted before the cap existed — the case
// #hydrateSearchRow's bounded-window fallback exists for.
