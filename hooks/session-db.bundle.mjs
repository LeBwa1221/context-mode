import{createRequire as le}from"node:module";import{existsSync as T,unlinkSync as U,renameSync as W,readdirSync as ge,statSync as Ee,mkdirSync as me,copyFileSync as _e}from"node:fs";import{homedir as pe,tmpdir as ye}from"node:os";import{dirname as fe,join as $}from"node:path";var w=class{#e;constructor(e){this.#e=e}pragma(e){let r=this.#e.prepare(`PRAGMA ${e}`).all();if(!r||r.length===0)return;if(r.length>1)return r;let s=Object.values(r[0]);return s.length===1?s[0]:r[0]}exec(e){let t="",r=null;for(let a=0;a<e.length;a++){let i=e[a];if(r)t+=i,i===r&&(r=null);else if(i==="'"||i==='"')t+=i,r=i;else if(i===";"){let c=t.trim();c&&this.#e.prepare(c).run(),t=""}else t+=i}let s=t.trim();return s&&this.#e.prepare(s).run(),this}prepare(e){let t=this.#e.prepare(e);return{run:(...r)=>t.run(...r),get:(...r)=>{let s=t.get(...r);return s===null?void 0:s},all:(...r)=>t.all(...r),iterate:(...r)=>t.iterate(...r)}}transaction(e){return this.#e.transaction(e)}close(){this.#e.close()}},x=class{#e;constructor(e){this.#e=e}pragma(e){let r=this.#e.prepare(`PRAGMA ${e}`).all();if(!r||r.length===0)return;if(r.length>1)return r;let s=Object.values(r[0]);return s.length===1?s[0]:r[0]}exec(e){return this.#e.exec(e),this}prepare(e){let t=this.#e.prepare(e);return{run:(...r)=>t.run(...r),get:(...r)=>t.get(...r),all:(...r)=>t.all(...r),iterate:(...r)=>typeof t.iterate=="function"?t.iterate(...r):t.all(...r)[Symbol.iterator]()}}transaction(e){let t=s=>(...a)=>{this.#e.exec(s);try{let i=e(...a);return this.#e.exec("COMMIT"),i}catch(i){throw this.#e.exec("ROLLBACK"),i}},r=t("BEGIN DEFERRED");return r.deferred=r,r.immediate=t("BEGIN IMMEDIATE"),r.exclusive=t("BEGIN EXCLUSIVE"),r}close(){this.#e.close()}},_=null;function Se(n){let e=null;try{return e=new n(":memory:"),e.exec("CREATE VIRTUAL TABLE __fts5_probe USING fts5(x)"),!0}catch{return!1}finally{try{e?.close()}catch{}}}function he(n,e){let t=e!==void 0?e:globalThis.Bun;if(typeof t<"u"&&t!==null)return!0;let r=n??process.versions,[s,a]=(r.node??"0.0.0").split("."),i=Number(s),c=Number(a);return!Number.isFinite(i)||!Number.isFinite(c)?!1:i>22||i===22&&c>=5}function Te(){if(!_){let n=le(import.meta.url);if(globalThis.Bun){let e=n(["bun","sqlite"].join(":")).Database;_=function(r,s){let a=new e(r,{readonly:s?.readonly,create:!0}),i=new w(a);return s?.timeout&&i.pragma(`busy_timeout = ${s.timeout}`),i}}else if(he()){let e=null;try{({DatabaseSync:e}=n(["node","sqlite"].join(":")))}catch{e=null}e&&Se(e)?_=function(r,s){let a=new e(r,{readOnly:s?.readonly??!1}),i=new x(a);return s?.timeout&&i.pragma(`busy_timeout = ${s.timeout}`),i}:_=n("better-sqlite3")}else _=n("better-sqlite3")}return _}function V(n){n.pragma("journal_mode = WAL"),n.pragma("synchronous = NORMAL");try{n.pragma("mmap_size = 268435456")}catch{}}function X(n){try{n.pragma("wal_checkpoint(PASSIVE)")}catch{}}function H(n){if(!T(n))for(let e of["-wal","-shm"])try{U(n+e)}catch{}}function ve(n){for(let e of["","-wal","-shm"])try{U(n+e)}catch{}}function I(n){try{n.pragma("wal_checkpoint(TRUNCATE)")}catch{}try{n.close()}catch{}}function q(n="context-mode"){return $(ye(),`${n}-${process.pid}.db`)}var Re=new Int32Array(new SharedArrayBuffer(4));function be(n){n<=0||Atomics.wait(Re,0,0,n)}function De(n){return n.includes("SQLITE_BUSY")||n.includes("database is locked")||n.includes("SQLITE_IOERR")}function Le(n,e=[100,500,2e3]){let t;for(let r=0;r<=e.length;r++)try{return n()}catch(s){let a=s instanceof Error?s.message:String(s);if(!De(a))throw s;t=s instanceof Error?s:new Error(a),r<e.length&&be(e[r])}throw new Error(`SQLITE_BUSY: database is locked after ${e.length} retries. Original error: ${t?.message}`)}function Ne(n){return n.includes("SQLITE_CORRUPT")||n.includes("SQLITE_NOTADB")||n.includes("database disk image is malformed")||n.includes("file is not a database")}function Ce(n){let e=Date.now();for(let t of["","-wal","-shm"])try{W(n+t,`${n}${t}.corrupt-${e}`)}catch{}}function M(n){let{newDbPath:e,subdir:t,fileName:r,log:s}=n;if(T(e))return!1;let a,i;try{a=pe(),i=ge(a)}catch{return!1}let c=null;for(let d of i){if(!d.startsWith("."))continue;let u=$(a,d,"context-mode",t,r),l;try{l=Ee(u)}catch{continue}l.isFile()&&(!c||l.size>c.size)&&(c={path:u,size:l.size})}if(!c)return!1;try{me(fe(e),{recursive:!0});for(let d of["","-wal","-shm"]){let u=c.path+d;if(!T(u))continue;let l=`${e}${d}.adopting-${process.pid}-${Date.now()}`;try{_e(u,l),W(l,e+d)}catch{try{U(l)}catch{}}}}catch{return T(e)}return T(e)?(s?.(`context-mode: adopted legacy DB ${c.path} (${c.size} bytes) -> ${e}`),!0):!1}var h=Symbol.for("__context_mode_live_dbs_v3__"),A=(()=>{let n=globalThis;return n[h]||(n[h]=new Set,process.on("exit",()=>{for(let e of n[h])I(e);n[h].clear()})),n[h]})(),D=class{#e;#t;constructor(e){let t=Te();this.#e=e,H(e);let r;try{r=new t(e,{timeout:3e4}),V(r)}catch(s){let a=s instanceof Error?s.message:String(s);if(Ne(a)){Ce(e),H(e);try{r=new t(e,{timeout:3e4}),V(r)}catch(i){throw new Error(`Failed to create fresh DB after renaming corrupt file: ${i instanceof Error?i.message:String(i)}`)}}else throw s}this.#t=r,A.add(this.#t),this.initSchema(),this.prepareStatements()}get db(){return this.#t}get dbPath(){return this.#e}close(){A.delete(this.#t),I(this.#t)}withRetry(e){return Le(e)}cleanup(){A.delete(this.#t),I(this.#t),ve(this.#e)}};import{createHash as v}from"node:crypto";import{execFileSync as Oe}from"node:child_process";import{accessSync as Ae,constants as we,existsSync as f,mkdirSync as xe,realpathSync as Ie,renameSync as k}from"node:fs";import{homedir as J}from"node:os";import{dirname as Ue,isAbsolute as Z,join as E,resolve as y}from"node:path";var g="CONTEXT_MODE_DIR",P="sessions",F="content",R=class extends Error{kind;path;overrideEnvVar;ignoredEnvVar;ignoredReason;constructor(e,t,r=g,s,a,i={}){super(a??Be(e,t,i),{cause:s}),this.name="StorageDirectoryError",this.kind=e,this.path=t,this.overrideEnvVar=r,this.ignoredEnvVar=i.ignoredEnvVar,this.ignoredReason=i.ignoredReason}},N=new Map;function st(n){let e=n.env??process.env,t=n.legacySessionDirEnv,r=t?e[t]?.trim():void 0;return r&&t?(n.onLegacySessionDir?.(t,r),r):E(Me(n.configDir,n.configDirEnv,e),"context-mode","sessions")}function Me(n,e,t){let r=e?t[e]:void 0;return r&&r.trim()!==""?G(r.trim()):G(n,J())}function G(n,e){return n.startsWith("~")?y(J(),n.replace(/^~[/\\]?/,"")):Z(n)?y(n):e?y(e,n):y(n)}function ke(n,e,t){return new R(n,e,g,void 0,[`Invalid ${g} for context-mode ${n} directory: ${t}`,re()].join(`
`))}function ee(n){let e=process.env[g];if(e===void 0)return{kind:"unset"};let t=e.trim();if(!t)return{kind:"ignored-empty",ignoredEnvVar:g,ignoredReason:"empty"};if(!Z(t))throw ke(n,t,`${g} must be an absolute path.`);return{kind:"override",root:y(t)}}function Fe(n){return n.kind==="ignored-empty"?{ignoredEnvVar:n.ignoredEnvVar,ignoredReason:n.ignoredReason}:{}}function te(n,e){let t=ee(n);return t.kind!=="override"?null:{kind:n,path:E(t.root,e),envVar:g,source:"override"}}function Pe(n,e,t){return{kind:n,path:y(e()),envVar:null,source:"default",...t}}function ne(n){let e=ee("session");return e.kind==="override"?{kind:"session",path:E(e.root,P),envVar:g,source:"override"}:Pe("session",n,Fe(e))}function ot(n){let e=te("content",F);if(e)return e;let t=ne(n);return{kind:"content",path:E(Ue(t.path),F),envVar:t.envVar,source:t.source,ignoredEnvVar:t.ignoredEnvVar,ignoredReason:t.ignoredReason}}function it(n){let e=te("stats",P);if(e)return e;let t=ne(n);return{kind:"stats",path:t.path,envVar:t.envVar,source:t.source,ignoredEnvVar:t.ignoredEnvVar,ignoredReason:t.ignoredReason}}function at(n){return n.message}function ct(n){return n.source==="override"&&n.envVar?`via ${n.envVar}`:n.ignoredEnvVar&&n.ignoredReason==="empty"?`default; ignored empty ${n.ignoredEnvVar}`:"default"}function ut(){N.clear()}function dt(n){let e=[n.kind,n.path,n.source,n.envVar??"",n.ignoredEnvVar??"",n.ignoredReason??""].join("\0"),t=N.get(e);if(t instanceof R)throw t;if(t===n.path)return t;try{return xe(n.path,{recursive:!0}),Ae(n.path,we.W_OK),N.set(e,n.path),n.path}catch(r){let s=new R(n.kind,Ve(r)??n.path,g,r,void 0,{ignoredEnvVar:n.ignoredEnvVar,ignoredReason:n.ignoredReason});throw N.set(e,s),s}}function Be(n,e,t={}){return[`context-mode ${n} directory is not writable: ${e}`,je(t),re()].filter(Boolean).join(`
`)}function je(n){return n.ignoredEnvVar&&n.ignoredReason==="empty"?`Ignored empty ${n.ignoredEnvVar}; using adapter default.`:null}function re(){return`Set ${g} to a writable absolute path.`}function Ve(n){if(!n||typeof n!="object")return null;let e=n.path;return typeof e=="string"&&e.length>0?e:null}var p;function m(n){let e=n.replace(/\\/g,"/");return/^\/+$/.test(e)?"/":/^[A-Za-z]:\/+$/.test(e)?`${e.slice(0,2)}/`:e.replace(/\/+$/,"")}function Y(n){let e=n;try{e=Ie.native(n)}catch{}let t=m(e);return process.platform==="win32"||process.platform==="darwin"?t.toLowerCase():t}function se(n,e){return Oe("git",["-C",n,...e],{encoding:"utf-8",timeout:2e3,stdio:["ignore","pipe","ignore"]}).trim()}function He(n){let e=se(n,["rev-parse","--show-toplevel"]);return e.length>0?m(e):null}function We(n){let e=se(n,["worktree","list","--porcelain"]).split(/\r?\n/).find(t=>t.startsWith("worktree "))?.replace("worktree ","")?.trim();return e?m(e):null}function $e(n=process.cwd()){let e=process.env.CONTEXT_MODE_SESSION_SUFFIX;if(p&&p.projectDir===n&&p.envSuffix===e)return p.suffix;let t="";if(e!==void 0)t=e?`__${e}`:"";else try{let r=He(n),s=We(n);if(r&&s){let a=Y(r),i=Y(s);a!==i&&(t=`__${v("sha256").update(a).digest("hex").slice(0,8)}`)}}catch{}return p={projectDir:n,envSuffix:e,suffix:t},t}function lt(){p=void 0}function oe(n){return v("sha256").update(m(n)).digest("hex").slice(0,16)}function ie(n){let e=m(n),t=process.platform==="darwin"||process.platform==="win32"?e.toLowerCase():e;return v("sha256").update(t).digest("hex").slice(0,16)}function gt(n){let{projectDir:e,contentDir:t}=n,r=ie(e),s=E(t,`${r}.db`);if(f(s))return s;let a=oe(e);if(a===r)return s;let i=E(t,`${a}.db`);if(f(i)){try{k(i,s);for(let c of["-wal","-shm"])try{k(i+c,s+c)}catch{}}catch{}if(f(s))return s}return M({newDbPath:s,subdir:F,fileName:`${r}.db`}),s}function Et(n){return Xe({...n,ext:".db"})}function Xe(n){let{projectDir:e,sessionsDir:t,ext:r}=n,s=n.suffix??$e(e),a=ie(e),i=E(t,`${a}${s}${r}`);if(f(i))return i;let c=oe(e);if(c===a)return i;let d=E(t,`${c}${s}${r}`);if(f(d)){try{k(d,i)}catch{}if(f(i))return i}return r===".db"&&M({newDbPath:i,subdir:P,fileName:`${a}${s}${r}`}),i}var K=1e3,z=5;function L(n){let e=Number(n);return!Number.isFinite(e)||e<=0?0:Math.floor(e)}var o={insertEvent:"insertEvent",getEvents:"getEvents",getEventsByType:"getEventsByType",getEventsByPriority:"getEventsByPriority",getEventsByTypeAndPriority:"getEventsByTypeAndPriority",getEventCount:"getEventCount",getLatestAttributedProject:"getLatestAttributedProject",checkDuplicate:"checkDuplicate",evictLowestPriority:"evictLowestPriority",updateMetaLastEvent:"updateMetaLastEvent",ensureSession:"ensureSession",getSessionStats:"getSessionStats",getSessionRollup:"getSessionRollup",getMaxFileEdits:"getMaxFileEdits",getLatestCommitMessage:"getLatestCommitMessage",incrementCompactCount:"incrementCompactCount",getUsageCursor:"getUsageCursor",setUsageCursor:"setUsageCursor",upsertResume:"upsertResume",getResume:"getResume",markResumeConsumed:"markResumeConsumed",claimLatestUnconsumedResume:"claimLatestUnconsumedResume",deleteEvents:"deleteEvents",deleteMeta:"deleteMeta",deleteResume:"deleteResume",getOldSessions:"getOldSessions",searchEvents:"searchEvents",incrementToolCall:"incrementToolCall",getToolCallTotals:"getToolCallTotals",getToolCallByTool:"getToolCallByTool",getEventBytesSummary:"getEventBytesSummary"},qe=[["project_dir","TEXT NOT NULL DEFAULT ''"],["attribution_source","TEXT NOT NULL DEFAULT 'unknown'"],["attribution_confidence","REAL NOT NULL DEFAULT 0"],["bytes_avoided","INTEGER NOT NULL DEFAULT 0"],["bytes_returned","INTEGER NOT NULL DEFAULT 0"]];function ae(n){let e=n.pragma("table_xinfo(session_events)"),t=new Set(e.map(s=>s.name)),r=!1;for(let[s,a]of qe)t.has(s)||(n.exec(`ALTER TABLE session_events ADD COLUMN ${s} ${a}`),r=!0);return r&&n.exec("CREATE INDEX IF NOT EXISTS idx_session_events_project ON session_events(session_id, project_dir)"),r}function mt(n,e){let t=null;try{t=new e(n),ae(t)}catch{}finally{try{t?.close()}catch{}}}var Q=class n extends D{#e=0;static CHECKPOINT_EVERY=20;constructor(e){super(e?.dbPath??q("session"))}#t(){this.#e++,this.#e%n.CHECKPOINT_EVERY===0&&X(this.db)}stmt(e){return this.stmts.get(e)}initSchema(){try{let t=this.db.pragma("table_xinfo(session_events)").find(r=>r.name==="data_hash");t&&t.hidden!==0&&this.db.exec("DROP TABLE session_events")}catch{}this.db.exec(`
